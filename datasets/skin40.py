...
class Skin40(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.preprocessed = os.path.join("/home/23/dexia/Storage/from97/CoOp_new/DATA", "preprocessed.pkl")
        self.split_fewshot_dir = os.path.join("/home/23/dexia/Storage/from97/CoOp_new/DATA", os.path.basename(self.dataset_dir), "split_fewshot")
